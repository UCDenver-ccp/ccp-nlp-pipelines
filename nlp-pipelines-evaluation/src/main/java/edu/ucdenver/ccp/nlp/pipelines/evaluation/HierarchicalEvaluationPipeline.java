...
import edu.ucdenver.ccp.nlp.ext.uima.annotators.comparison.hierarchical.SimpleHierarchicalAnnotationComparator_AE;
 ...
 * 
 */
public class HierarchicalEvaluationPipeline {
	 ...
	 */
	public HierarchicalEvaluationPipeline(TypeSystemDescription tsd, CollectionReader collectionReader,
			SpanComparatorType spanComparatorType, File oboFile,
	...
	private List<AnalysisEngineDescription> getAnnotationComparisonComponents(SlotRemovalOption slotRemovalOption)
		...
		AnalysisEngineDescription annotationComparatorDescription = SimpleHierarchicalAnnotationComparator_AE
				.createAnalysisEngineDescription(tsd, spanComparatorType, oboFile, evalResultsOutputFile,
						goldGroup, evalGroup);
